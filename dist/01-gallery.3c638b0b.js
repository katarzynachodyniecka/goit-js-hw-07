...
function createGallery() {
    for(let i = 0; i < 9; i++){
        ...
        const gallery = `<a class="gallery__link" href="${(0, _galleryItemsJs.galleryItems)[i].original}">
<img
  class="gallery__image"
  src="${(0, _galleryItemsJs.galleryItems)[i].preview}"
  data-source="${(0, _galleryItemsJs.galleryItems)[i].original}"
  alt="${(0, _galleryItemsJs.galleryItems)[i].description}"
/>
</a>`;
...
},{}]},["jAC0k","9de4I"], "9de4I", "parcelRequire716c")
